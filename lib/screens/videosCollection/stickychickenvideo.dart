...
class StickyChickenVideo extends StatefulWidget {
  @override
  _StickyChickenVideoState createState() => _StickyChickenVideoState();
}

class _StickyChickenVideoState extends State<StickyChickenVideo> {
  String videoURL = "https://www.youtube.com/watch?v=ajg22OPSH6c";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Sticky rice with chicken',style: TextStyle(fontFamily: 'TypeWriter'),),
