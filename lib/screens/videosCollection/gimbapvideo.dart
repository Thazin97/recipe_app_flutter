...
class GimbapVideo extends StatefulWidget {
  @override
  _GimbapVideoState createState() => _GimbapVideoState();
}

class _GimbapVideoState extends State<GimbapVideo> {
  String videoURL = "https://www.youtube.com/watch?v=QgkvphbZwc4";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Avocado gimbap',style: TextStyle(fontFamily: 'TypeWriter'),),
