...
class CoconutNoodleVideo extends StatefulWidget {
  @override
  _CoconutNoodleVideoState createState() => _CoconutNoodleVideoState();
}

class _CoconutNoodleVideoState extends State<CoconutNoodleVideo> {
  String videoURL = "https://www.youtube.com/watch?v=zxWxFc8KGAU";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Coconut Noodle',style: TextStyle(fontFamily: 'TypeWriter'),),
