...
class CoconutVideo extends StatefulWidget {
  @override
  _CoconutVideoState createState() => _CoconutVideoState();
}

class _CoconutVideoState extends State<CoconutVideo> {
  String videoURL = "https://www.youtube.com/watch?v=FVu1879j0wE";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Coconut dessert',style: TextStyle(fontFamily: 'TypeWriter'),),
