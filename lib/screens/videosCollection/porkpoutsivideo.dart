...
class PorkPoutsiVideo extends StatefulWidget {
  @override
  _PorkPoutsiVideoState createState() => _PorkPoutsiVideoState();
}

class _PorkPoutsiVideoState extends State<PorkPoutsiVideo> {
  String videoURL = "https://www.youtube.com/watch?v=3AyA3kCgAWM";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Pork poutsi',style: TextStyle(fontFamily: 'TypeWriter'),),
