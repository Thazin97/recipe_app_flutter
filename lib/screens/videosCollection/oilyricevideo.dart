...
class OilyRiceVideo extends StatefulWidget {
  @override
  _OilyRiceVideoState createState() => _OilyRiceVideoState();
}

class _OilyRiceVideoState extends State<OilyRiceVideo> {
  String videoURL = "https://www.youtube.com/watch?v=ojpjKKGITkQ";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Oily Rice',style: TextStyle(fontFamily: 'TypeWriter'),),
