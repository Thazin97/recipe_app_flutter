...
class PorkCurryVideo extends StatefulWidget {
  @override
  _PorkCurryVideoState createState() => _PorkCurryVideoState();
}

class _PorkCurryVideoState extends State<PorkCurryVideo> {
  String videoURL = "https://www.youtube.com/watch?v=llmX0Q_xWPw";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Pork curry with bean paste',style: TextStyle(fontFamily: 'TypeWriter'),),
