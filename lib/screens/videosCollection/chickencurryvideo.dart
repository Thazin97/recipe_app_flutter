...
class ChickenCurryVideo extends StatefulWidget {
  @override
  _ChickenCurryVideoState createState() => _ChickenCurryVideoState();
}

class _ChickenCurryVideoState extends State<ChickenCurryVideo> {
  String videoURL = "https://www.youtube.com/watch?v=hELmT7Lf_iI";
        ...
        if (orientation == Orientation.landscape) {
          ...
          return Scaffold(
              appBar:  AppBar(
                  ...
                  title: Text('Chicken Curry',style: TextStyle(fontFamily: 'TypeWriter'),),
