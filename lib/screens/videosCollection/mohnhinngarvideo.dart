...
class MohnhinngarVideo extends StatefulWidget {
  @override
  _MohnhinngarVideoState createState() => _MohnhinngarVideoState();
}

class _MohnhinngarVideoState extends State<MohnhinngarVideo> {
  String videoURL = "https://www.youtube.com/watch?v=LbNFF7PL8Rw";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Rice noodle soup',style: TextStyle(fontFamily: 'TypeWriter'),),
