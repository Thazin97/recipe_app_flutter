...
class EggPuddingVideo extends StatefulWidget {
  @override
  _EggPuddingVideoState createState() => _EggPuddingVideoState();
}

class _EggPuddingVideoState extends State<EggPuddingVideo> {
  String videoURL = "https://www.youtube.com/watch?v=AdhxJ9XcamM";
      ...
      if (orientation == Orientation.landscape) {
        ...
        return Scaffold(
          appBar:  AppBar(
            ...
            title: Text('Egg Pudding',style: TextStyle(fontFamily: 'TypeWriter'),),
